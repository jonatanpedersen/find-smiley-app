...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }()), __webpack_require__(131), __webpack_require__(132)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(132), __webpack_require__(131), (function() { return this; }())))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _stringify = __webpack_require__(370);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _objectified = __webpack_require__(377);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	function createSearch(searchIndex, documents) {
		return function search(filter, sort, offset, length) {
			filter = filter && filter.toLowerCase().split(' ') || [];
	
			var filteredDocuments = (0, _objectified.filterObject)(documents, function (document) {
				return filter.every(function (word) {
					return searchIndex.get(document).indexOf(word) > -1;
				});
			});
			var sortedDocuments = (0, _objectified.sortObject)(filteredDocuments, sort);
			var limitedDocuments = (0, _objectified.limitObject)(sortedDocuments, offset, length);
	...
	function createSearchIndex(documents) {
		return (0, _keys2.default)(documents).reduce(function (searchIndex, documentId) {
			var document = documents[documentId];
			searchIndex.set(document, (0, _keys2.default)(getUniqueStrings(document)).join(' '));
	...
	function getUniqueStrings(object, map) {
		...
		object && (0, _keys2.default)(object).forEach(function (key) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.limitObject = limitObject;
	exports.filterObject = filterObject;
	exports.groupObject = groupObject;
	...
	function sortObject(object, predicate) {
		...
		return (0, _keys2.default)(object).sort(function (a, b) {
			return predicate(a).localeCompare(predicate(b));
		}).reduce(function (memo, key) {
			memo[key] = object[key];return memo;
		}, {});
	}
	
	function limitObject(object, offset, length) {
		return (0, _keys2.default)(object).slice(offset, offset + length).reduce(function (memo, key) {
			memo[key] = object[key];return memo;
		}, {});
	}
	...
	function filterObject(object, filter) {
		...
		return (0, _keys2.default)(object).reduce(function (filteredObject, key) {
			var value = object[key];
			var isMatch = filter(value);
	...
	function groupObject(object, predicate) {
		if ((typeof object === 'undefined' ? 'undefined' : (0, _typeof3.default)(object)) !== 'object') {
			throw new TypeError('object is not an object');
		}
		...
		return (0, _keys2.default)(object).reduce(function (groups, objectKey) {
			var groupKey = predicate(object[objectKey]);
	...
	function mapObject(object, map) {
		...
		return (0, _keys2.default)(object).reduce(function (newObject, key) {
			var value = object[key];
	...
	function joinObject(object1, object2, predicate, target) {
		if ((typeof object1 === 'undefined' ? 'undefined' : (0, _typeof3.default)(object1)) !== 'object') {
			throw new TypeError('object1 is not an object');
		}
	
		if ((typeof object2 === 'undefined' ? 'undefined' : (0, _typeof3.default)(object2)) !== 'object') {
		...
		var groups = groupObject(object2, predicate);
		return mapObject(object1, function (value, key) {
			return (0, _assign2.default)({}, value, (0, _defineProperty3.default)({}, target, groups[key]));
		});
	}
	...
	function sumObject(object, predicate) {
		if ((typeof object === 'undefined' ? 'undefined' : (0, _typeof3.default)(object)) !== 'object') {
			throw new TypeError('object is not an object');
		}
		...
		return objectValues(object).reduce(function (sum, value) {
			return sum + (predicate(value) || 0);
		}, 0);
	}
...
/***/ function(module, exports, __webpack_require__) {
	        ...
	        switch (_context4.prev = _context4.next) {
	          case 0:
	            ...
	            return _context4.delegateYield(_regenerator2.default.mark(function _callee3() {
	              var documents, _position, _search, handlers, dispatch;
	                ...
	                while (1) {
	                  switch (_context3.prev = _context3.next) {
	                    case 0:
	                      documents = [];
	                      _position = null;
	                      _search = createSearch2(documents, _position);
	                      handlers = {
	                        position: function () {
	                          var _ref2 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(newPosition) {
	                          ...
	                          return function position(_x) {
	                            return _ref2.apply(this, arguments);
	                          };
	                        }(),
	                        search: function () {
	                          var _ref3 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2(searchQuery) {
	                            var searchResult;
	                            return _regenerator2.default.wrap(function _callee2$(_context2) {
	                              while (1) {
	                                switch (_context2.prev = _context2.next) {
	                                  case 0:
	                                    searchResult = _search(searchQuery, null, 0, 20);
	                      ...
	                      dispatch = createDispatch(handlers);
	
	
	                      onmessage = function onmessage(event) {
	                        return dispatch(event.data.topic, event.data.data);
	                      };
	          ...
	          case 4:
	            ...
	            postMessage({ topic: 'error', data: _context4.t1 });
	    ...
	    return _regenerator2.default.wrap(function _callee5$(_context5) {
	      while (1) {
	        switch (_context5.prev = _context5.next) {
	          case 0:
	            return _context5.abrupt('return', (0, _api.get)('/api/documents'));
	...
	var _search2 = __webpack_require__(372);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	function createDispatch(handlers) {
	  return function () {
	    var _ref5 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee6(topic, data) {
	      var handler;
	        ...
	        while (1) {
	          switch (_context6.prev = _context6.next) {
	            case 0:
	              ...
	              return _context6.abrupt('return', handler(data));
	...
	function createSearch2(documents, position) {
	  ...
	  var searchIndex = (0, _search2.createSearchIndex)(documents);
	
	  return (0, _search2.createSearch)(searchIndex, documents);
	}
